...
<header class="fixed w-full">
    <nav class="bg-white border-gray-200 py-2.5 dark:bg-gray-900 shadow-md">
        <div class="flex flex-wrap items-center justify-between max-w-screen-xl px-4 mx-auto">
            ...
            <div class="flex items-center sm:order-1 md:order-2">
                @auth
            ...
            {{--<div class="flex flex-wrap items-center justify-between hidden w-full lg:flex lg:w-auto lg:order-1">--}}
            <div class="flex flex-wrap justify-between max-w-screen-xl lg:w-auto sm:order-2 md:order-1">
...
<section class="bg-white dark:bg-gray-900">
    <div class="grid max-w-screen-xl px-4 pt-40 pb-8 mx-auto lg:gap-8 xl:gap-0 lg:py-16 lg:grid-cols-12 lg:pt-28">
